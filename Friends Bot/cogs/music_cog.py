...
class music_cog(commands.Cog):
    ...
    async def p(self, ctx, *args):
        ...
        if voice_channel is None:
            #you need to be connected so that the client knows where to go
...
def setup(client): # a extension must have a setup function
    client.add_cog(music_cog(client)) # adding a cog
